...
#core/batch
svc='core/batch'
params='{"params":[{"svc":"core/search_items","params":{"spec":{"itemsType":"avl_unit","propName":"sys_name","propValueMask":"test","sortType":"sys_name"},"force":1,"flags":261,"from":0,"to":19}}],"flags":0}'
